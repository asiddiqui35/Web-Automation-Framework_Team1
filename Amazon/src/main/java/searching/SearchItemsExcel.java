...
public class SearchItemsExcel extends CommonAPI {
    ...
    public void testExcel() throws IOException {
        ArrayList<String> searchAbleItems = dataFromExcel("/Users/kaniz/Desktop/Web-Automation-Framework_Team1/Amazon/data/file1.xls","Sheet1",1);
        for (int i = 0; i < searchAbleItems.size(); i++) {

            typeByXpath("//*[@id=\"twotabsearchtextbox\"]", searchAbleItems.get(i));
            clearInputField("//*[@id=\"twotabsearchtextbox\"]");
        }
    }
}
